...
// Version info is now provided by lib/version/buildinfo.h
// Use BuildInfo::version instead of VERSION macro
// Note: VERSION macro kept for backward compatibility
#include <buildinfo.h>
#define VERSION BuildInfo::version
