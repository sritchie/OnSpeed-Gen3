...
void UpdateHeader()
    ...
    pageHeader.replace("wifi_fw", String("OnSpeed Version: ") + VERSION);
...
<div class="content-container">
    ...
    <div class="form round-box">)#";
        ...
        // Content length calculated but not used - sending in chunks instead
        // int contentLength = sPage.length() + SjsSGfilter.length() + ...
