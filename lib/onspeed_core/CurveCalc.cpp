...
// Debug logging is optional - disabled by default for simplicity
// To enable on ESP32, include Globals.h and define LOG_DEBUG appropriately
#ifndef LOG_DEBUG
#define LOG_DEBUG(...)
#endif

// Calculate an output value based on one of the defined curves. This is used
// to calculate AOA from coefficient of pressure but really it could be used
// for anything.
//
// y = f(x)
...
float CurveCalc(float fX, SuCalibrationCurve suCurve)
{
    ...
    // Polynomial
    // TODO we can make this better by using the normalized form
